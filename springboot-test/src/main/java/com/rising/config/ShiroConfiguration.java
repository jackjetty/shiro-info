...
import com.rising.security.MyShiroRealm;
...
/*
   ...
   // @Value("${spring.redis.host}")
	private String host="115.231.203.186";

	//@Value("${spring.redis.port}")
	private int port=6379;
	
	//@Value("${spring.redis.password}")
	private String password="rising";
...
/*
	...
	@Bean(name = "myShiroRealm")
    public MyShiroRealm myShiroRealm(@Qualifier("cachemanager") RedisCacheManager cachemanager) {  
...
//  }
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(MyShiroRealm myShiroRealm,@Qualifier("cachemanager") RedisCacheManager cachemanager) {
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 --> 
    ...
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, UserService userService){
        ...
        //filterChainDefinitionMap.put("/user.do", "authc");// 这里为了测试，只限制/user，实际开发中请修改为具体拦截的请求规则
        filterChainDefinitionMap.put("/index.do", "authc");
        ...
        //filterChainDefinitionMap.put("/user.do", "authc,perms[user:edit1]");
        filterChainDefinitionMap.put("/login.do", "anon");
        filterChainDefinitionMap.put("/logout.do", "anon");
        filterChainDefinitionMap.put("/**.do", "anon");//anon 可以理解为不拦截
